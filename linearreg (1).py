...
new_data=pd.read_csv('Deep_Learning_tas_SSP585_2025_2100_processed_block_maxima.csv')
...
new_data.to_csv('dl_data_tempvalues.csv', index=False)
results_df.to_csv('dl_regression_coefficients.csv', index=False)